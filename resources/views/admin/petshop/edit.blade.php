...
@section('additional-scripts')
    ...
    <script type="text/javascript">
        var options = {
            center: [{{ $petshop->latitude }},{{ $petshop->longitude }}],
            zoom: 13
        }
        ...
        var myMarker = L.marker([{{old('latitude', $petshop->latitude )}},{{old('longitude', $petshop->longitude)}}], {title: "MyPoint", alt: "The Big I", draggable: true})
            .addTo(map)
