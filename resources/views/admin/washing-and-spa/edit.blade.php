...
@section('additional-scripts')
    ...
    <script type="text/javascript">
        var options = {
            center: [{{ $washingAndSpa->latitude }},{{ $washingAndSpa->longitude }}],
            zoom: 13
        }
        ...
        var myMarker = L.marker([{{old('latitude', $washingAndSpa->latitude )}},{{old('longitude', $washingAndSpa->longitude)}}], {title: "MyPoint", alt: "The Big I", draggable: true})
            .addTo(map)
